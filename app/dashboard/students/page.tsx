...
import { Trash2, Eye, Search, Pencil, Upload, ImageIcon, X } from 'lucide-react';
...
export default function StudentsList() {
  ...
  const [editIdCard, setEditIdCard] = useState<File | null>(null);
  ...
  const handleEditImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => setEditIdCardPreview(reader.result as string);
  ...
  const handleEditSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Update student in the local list, including new image if uploaded
        setStudents(students.map(s =>
          s.id === editStudent.id
            ? {
                ...s,
                ...editForm,
                id_card_path: editIdCardPreview || s.id_card_path,
              }
            : s
        ));
        setTimeout(() => {
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-auto">
            ...
            <form onSubmit={handleEditSubmit} className="p-6 space-y-4">
              ...
              <div className="border-t border-gray-200 pt-4 mt-2">
                ...
                {editStudent?.id_card_path && !editIdCardPreview && (
                  <div className="mb-3">
                    <p className="text-xs text-gray-500 mb-2">Current ID Card:</p>
                    <div className="border border-gray-200 rounded-lg overflow-hidden bg-gray-50 flex justify-center p-2 max-h-40">
                      <img
                        src={editStudent.id_card_path}
                        alt="Current ID Card"
                ...
                {editIdCardPreview && (
                  <div className="mb-3">
                    <div className="flex items-center justify-between mb-2">
                      <p className="text-xs text-green-600 font-medium">New ID Card (preview):</p>
                      <button
                        type="button"
                    ...
                    <div className="border border-green-200 rounded-lg overflow-hidden bg-green-50 flex justify-center p-2 max-h-40">
                      <img
                        src={editIdCardPreview}
                        alt="New ID Card Preview"
                        className="max-h-36 object-contain rounded"
                      />
                    </div>
                  </div>
                ...
                <div
                  ...
                  className="flex items-center justify-center gap-2 w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-indigo-400 hover:bg-indigo-50 transition-colors"
                >
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="button"
                  onClick={() => { setEditStudent(null); setEditMessage(''); setEditIdCard(null); setEditIdCardPreview(null); }}
